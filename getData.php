...
while ($r = $modx->db->getRow($res)) {
	...
	$edit = '<a href="#" title="Редактировать" onclick="addRow('.$r['id'].');return false;">Ред.</a>';
	$del = '<a href="#" title="Удалить" onclick="if(confirm(\'Вы уверены?\')){delRow('.$r['id'].')};return false">Уд.</a>';
